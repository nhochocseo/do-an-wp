...
add_action( 'widgets_init', 'awardthemes_successful_project_widget' );
if( !function_exists('awardthemes_successful_project_widget') ){
	function awardthemes_successful_project_widget() {
		register_widget( 'Widget_Successful_Project' );
	}
}	
	
class Widget_Successful_Project extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( false, esc_attr__( 'AwardThemes: Successful Project Gallery', 'woodest' ), $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		require_once (get_template_directory() .'/inc/widgets/successful-project/views/widget.php');
	}
