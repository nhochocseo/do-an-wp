...
add_action( 'widgets_init', 'awardthemes_recent_posts_widget' );
if( !function_exists('awardthemes_recent_posts_widget') ){
	function awardthemes_recent_posts_widget() {
...
class Widget_Recent_Posts extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( false, esc_attr__( 'AwardThemes: Recent Posts', 'woodest' ), $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		require_once (get_template_directory() .'/inc/widgets/recent-posts/views/widget.php');
	}
