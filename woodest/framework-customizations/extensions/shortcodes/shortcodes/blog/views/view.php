...
?>
	...
	<div class="blog-holder <?php echo esc_attr($page_class); ?>">
		...
		if($blog_style == 'blog_full'){
			...
			if($blog_slide == "co") {
				...
				<div class="row">
					<div class="no-padding slider-post slider-section">
						<div id="post_slider" class="carousel carousel-web" data-ride="carousel">
				...
				<div class="row">
					<div class="no-padding slider-post slider-section">
						<div id="post_slider1" class="carousel carousel-mobile" data-ride="carousel">
							<div class="carousel-inner" role="listbox">
								<!-- <div class="item active"> -->
								<?php 
									$slide_count = 0;
									while($the_query->have_posts()){ 
										...
										global $post;
										;?>
											<div class="item col-xs-12 <?php if($slide_count == 0) { echo 'active';} ?>">
												<?php get_template_part( 'template-parts/post/content', 'grid' ); ?>
											</div>
										<?php
										$slide_count = $slide_count+1; 
							...
							<a class="left carousel-control"  href="#post_slider1" role="button" data-slide="prev">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/back.png">
							</a>
							<a  class="right carousel-control" href="#post_slider1" role="button" data-slide="next">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/login_next_icon_544837.png">
							</a>
						</div>
					</div>
			...
			<?php } else {
			?>
				<div class="row tin-tuc-mobile">
					<?php 
					while($the_query->have_posts()){ 
						$the_query->the_post();
						global $post; ?>
						<div class="<?php echo esc_attr($blog_cols); ?> col-sm-12">
							<?php get_template_part( 'template-parts/post/content', 'grid' ); ?>
						</div>
						<?php
					} ?>
