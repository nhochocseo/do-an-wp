...
$options = array(
	...
	'blog_category' => array(
        ...
        'population' => 'taxonomy',
        'source'     => 'categories_kien_truc',
        'desc'       => esc_attr__( 'Show posts by category selection.','woodest' ),
    ),
    'textcontent' => array(
		'label' => esc_attr__('Nội dung mo tả dưới slide', 'woodest'),
		'type'  => 'text',
	...
	'blog_style' => array(
		...
		'type'  => 'select',
		'choices' => array(
			'grid_box' => esc_attr__('Blog Box', 'woodest'),
			'blog_grid_full' => esc_attr__('Blog Grid Full', 'woodest'),
		),
	),
	'blog_cols' => array(
