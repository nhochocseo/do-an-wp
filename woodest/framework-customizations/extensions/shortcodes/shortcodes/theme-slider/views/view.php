...
$image_icon = isset( $atts['image_icon']['attachment_id'] ) && $atts['image_icon']['attachment_id'] !='' ? $atts['image_icon']['attachment_id'] : '';
?>
	<div class="row">
		<div id="slider-section" class="slider-section slider-section2 no-padding">
			<div id="photo_slider" class="carousel slide" data-ride="carousel">
				...
				<span class="image-icon">
					<?php echo wp_get_attachment_image($image_icon,'full' ); ?>
				</span>
			</div>		
		</div>
	</div>